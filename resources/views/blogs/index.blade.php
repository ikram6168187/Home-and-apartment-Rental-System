...
<head>
    ...
    /* NEW: card jaisa look — margin + rounded corners */
    max-width:1200px;
    margin:20px auto 0;
    border-radius:30px;
    ...
    overflow:hidden;
        ...
        /* =========================================
           NEW: CURVED BOTTOM EDGE FOR HERO
           (creates the smooth curve instead of a
           sharp/cone-like straight edge)
        ========================================= 
        ...
        .blog-hero::after{
            ...
            background:#f6f4f1; /* matches body background */
