    ...
    <div class="content">
        ...
        <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:14px; margin-bottom:20px;">
            ...
            overflow:hidden;">
                ...
                font-weight:800; 
                color:#1a1209; 
                margin:0 0 4px;">{{ $totalBookings }}</h2>
                <p 
                style=
                "font-size:12px; 
                color:#888; 
                margin:0;">Total Bookings</p>
                <span 
                style=
                ...
                border-radius:10px; 
                font-size:10px; 
                font-weight:600;">{{ $pendingBookings }} Pending</span>
            </div>
            ...
            overflow:hidden;">
                ...
                font-weight:800; 
                color:#1a1209; 
                margin:0 0 4px;">{{ $unreadMessages ?? 0 }}</h2>
                <p 
                style=
                "font-size:12px; 
                color:#888;
                 margin:0;">New Messages</p>
                <span 
                style=
                "display:inline-block; 
                margin-top:8px; 
...
overflow:hidden;">
    ...
    font-weight:800; 
    color:#1a1209; 
    margin:0 0 4px;">{{ $totalServiceRequests ?? 0 }}</h2>
    <p 
    style=
    "font-size:12px; 
    color:#888; 
    margin:0;">Total Service Requests</p>
    <span 
    style=
    "display:inline-block; 
    margin-top:8px; 
    ...
    border-radius:10px; 
    font-size:10px; 
    font-weight:600;">{{ $pendingServiceRequests }} Pending</span>
</div>
        </div>
            ...
            border:1px solid #eee;">
                ...
                border-collapse:collapse;">
                    <tr>
                        ...
                        padding:6px 8px; 
                        text-align:left; 
                        border-bottom:1px solid #f0f0f0;">Name</th>
                        <th 
                        style=
                        "font-size:10px; 
                        font-weight:700; 
                        ...
                        padding:6px 8px; 
                        text-align:left; 
                        border-bottom:1px solid #f0f0f0;">Email</th>
                        <th 
                        style=
                        "font-size:10px; 
                        font-weight:700; 
                        ...
                        padding:6px 8px; 
                        text-align:left; 
                        border-bottom:1px solid #f0f0f0;">Properties</th>
                        <th 
                        style=
                        "font-size:10px; 
                        font-weight:700; 
                    ...
                    <tr>
                        ...
                        color:#1a1209; 
                        padding:10px 8px; 
                        border-bottom:1px solid #f8f8f8;">{{ $user->name }}</td>
                        <td 
                        style=
                        "font-size:11px; 
                        color:#888; 
                        padding:10px 8px;
                        border-bottom:1px solid #f8f8f8;">{{ $user->email }}</td>
                        <td 
                        style=
                        "padding:10px 8px; 
            ...
            border:1px solid #eee;">
                ...
                border-bottom:1px solid #f5f5f5;">
                    ...
                    gap:7px;">
                        ...
                        "fa-solid fa-map" 
                        style=
                        "color:#8a7060;"></i> Properties by City
                    </h3>
                </div>
                ...
                margin-bottom:12px;">
                    ...
                    overflow:hidden;">
                        ...
                        "height:100%; 
                        border-radius:4px; 
                        background:linear-gradient(to right,#1a1209,#8a6040); 
                        width:{{ ($city->total / $maxCity) * 100 }}%;"></div>
                    </div>
                    <span 
                    style=
                    "font-size:12px; 
                    ...
                    color:#1a1209; 
                    width:20px; 
                    text-align:right;">{{ $city->total }}</span>
                </div>
                @endforeach
            </div>
            ...
            border:1px solid #eee;">
                ...
                border-bottom:1px solid #f5f5f5;">
                    ...
                    gap:7px;">
                        ...
                        style=
                        "color:#8a7060;"></i> Recent Bookings
                    </h3>
                    <a 
                ...
                border-bottom:1px solid #f8f8f8;">
                    ...
                    "flex:1;">
                        ...
                        max-width:180px;">{{ $booking->property->title ?? 'N/A' }}</p>
                        <p 
                        style=
                        "font-size:11px; 
                        color:#888; 
                        margin:0;">{{ $booking->user->name ?? '' }} · {{ $booking->check_in->format('d M') }} – {{ $booking->check_out->format('d M') }}</p>
                    </div>
                    <span 
                    style=
                    "font-size:10px; 
